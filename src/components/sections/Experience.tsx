...
import { ExperienceImage } from '../../constants/images';
...
const experiences: ExperienceItem[] = [
  ...
  // },
  {
    ...
    logo: ExperienceImage.ASTRONOMER_LOGO,
    photos: [],
    captions: [],
  },
  {
  ...
  },
  {
    ...
    logo: ExperienceImage.PAYBYPHONE_LOGO,
    photos: [ExperienceImage.PAYBYPHONE_PICTURE],
    captions: [
  ...
  },
  {
    ...
    logo: ExperienceImage.APRYSE_LOGO,
    photos: [ExperienceImage.PDFTRON_PICTURE],
